...
% Su uso principal se encuentra en el posicionamiento de teléfonos móviles a partir de la señal de la torres de servicio: las grandes distancias a las que se encuentran aumentan la posibilidad de encontrar una gran atenuación y ruido, por lo que la determinación de la distancia de forma directa es, en general, inviable.

% \subsubsection{Límites teóricos}
